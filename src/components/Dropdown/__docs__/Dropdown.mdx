...
```tsx
import { Dropdown } from '@aroris/prima-ds';
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Controlled value for the dropdown</td>
      <td>
        <code>string</code>
      </td>
      <td>
