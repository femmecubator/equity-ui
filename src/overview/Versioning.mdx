...
1. <strong>Token-level changes</strong> – Adjustments to design tokens such as colors or typography.
2. <strong>Component-level changes</strong> – Structural updates or new variants to components.
...
* <u><strong>When a new token name is added on Figma, that triggers the ZH to Gitlab workflow.</strong></u>
